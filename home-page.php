                    ...
                    echo '<div class="col-sm-4">';
                        echo  '<div class="widget-image-card">';
                            echo '<div class="widget-image-card-header">';
                                echo '<img src="' . esc_attr(get_option($value3)) . '" alt="'. esc_attr(get_option($value1)) . '" title="' . esc_attr(get_option($value1)) . '">';
                    ...
                    echo '<div class="col-sm-3 mb-5">';
                            echo '<div class="row">';
                                echo '<div class="col-4">';
                                    echo '<img src="' . esc_attr(get_option($value1))  . '" alt="' . esc_attr(get_option($value2))  . '" title="' . esc_attr(get_option($value2)) . '">';
                                echo '</div>';
                                echo '<div class="col-8">';
                                    echo '<a href="' . esc_attr(get_option($value4)) . '"><h3 class="entry_title_04" title="' . esc_attr(get_option($value2)) . '">' . esc_attr(get_option($value2)) . '</h3></a>';
                                    echo '<p><a href="' . esc_attr(get_option($value4)) . '" title="' . esc_attr(get_option($value3)) . '">' . esc_attr(get_option($value3))  . '</a></p>';
                                echo '</div>';
                            echo '</div>';
                    echo '</div>';
